                    ...
                    <div class="row">
                        <div class="col-xs-12 head-pane">
                            <div class="col-md-12 pane">
                                ...
                                <div>
                                    <p>
                                        Er liep blijkbaar iets fout. Probeer de pagina ter vernieuwen.<br>
                                        Als dat niet lukt, klik <a href="${contextPath}/">hier</a> om terug te gaan naar de hoofdpagina.<br>
