...
public class TramSubroute extends PublicTransportSubroute {

    //<editor-fold defaultstate="expanded" desc="Attributes">
    //</editor-fold>

    //<editor-fold defaultstate="expanded" desc="Constructors">
    public TramSubroute(LocalDateTime startTime, LocalDateTime endTime, Location startLocation, Location endLocation, String text, double length, BigDecimal price,
